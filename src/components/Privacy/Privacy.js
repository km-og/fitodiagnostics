    ...
    <section className="privacy">
      ...
      <div className="privacy__container">
        ...
        <p className="privacy__text">
          ...
          безопасности персональных данных, предпринимаемые Фитодиагностика
          (далее — Оператор).
        </p>
      ...
      <div className="privacy__container">
        ...
        <ol className="privacy__list">
          ...
          <li className="privacy__item">
            ...
            Оператора fitodiagnostika@mail.ru с пометкой «Актуализация
            персональных данных».
          </li>
          <li className="privacy__item">
            ...
            fitodiagnostika@mail.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li className="privacy__item">
      ...
      <div className="privacy__container">
        ...
        <ol className="privacy__list">
          <li className="privacy__item">
            ...
            к Оператору с помощью электронной почты fitodiagnostika@mail.ru.
          </li>
          <li className="privacy__item">
          ...
          <li className="privacy__item">
            ...
            сети Интернет по адресу https://fitodiagnostika.ru/privacy.
          </li>
        </ol>
      </div>
    </section>
